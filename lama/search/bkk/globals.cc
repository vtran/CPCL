...
void build_landmarks_graph(bool reasonable_orders, FFHeuristic &g_ff_heur) {
...
//addin
void build_landmarks(bool generate_landmarks, bool reasonable_orders, FFHeuristic &g_ff_heur) {
    if(generate_landmarks){

	build_landmarks_graph(reasonable_orders, g_ff_heur);
    }
